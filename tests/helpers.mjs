export function sampleSpec(template) {
  ...
  if (template.profile === 'matrix') base.payload = {matrix:{x:['Версия 1','Версия 2'],y:['Сегмент А','Сегмент Б'],values:[{x:'Версия 1',y:'Сегмент А',value:4},{x:'Версия 2',y:'Сегмент А',value:8},{x:'Версия 1',y:'Сегмент Б',value:3},{x:'Версия 2',y:'Сегмент Б',value:9}]}};
  ...
  if (template.profile === 'calendar') base.payload = {calendar:[{date:'2026-01-02',value:4},{date:'2026-01-03',value:8},{date:'2026-01-04',value:2}]};
